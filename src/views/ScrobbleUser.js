...
import { faChevronLeft, faHistory, faSync, faUserFriends } from '@fortawesome/free-solid-svg-icons';
      ...
      return (
        <Row className="flex-lg-grow-1 mt-3">
          <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
            {sectionHeading}
            <Trans i18nKey="findFriendCopy">Enter a last.fm username to see their last tracks</Trans>:{searchForm}
        ...
        <React.Fragment>
          <div className="UserCard-container rect row no-gutters pb-3">
            <div className="col-sm-8 d-flex align-items-middle">
              <UserCard
                user={get(this.props.user, `profiles['${this.state.userToDisplay}']`)}
                name={this.state.userToDisplay}
                isHeading
                withLinkToProfile
              />
            </div>
      ...
      return (
        <div className="flex-lg-grow-1">
          <div className="row mb-3">
            ...
            <div className="col-md-4 d-flex align-items-center justify-content-end">{searchForm}</div>
          </div>
          <div className="row">
            <div className="col-md-7 mb-4">{this.state.isLoading ? <Spinner /> : friendScrobbles}</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(ScrobbleUser));
