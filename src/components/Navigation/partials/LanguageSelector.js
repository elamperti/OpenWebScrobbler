    ...
    <UncontrolledDropdown data-cy="LanguageSelector" className={`ows-LanguageSelector ${className}`} nav inNavbar>
      ...
      <DropdownMenu right>
        {languageList.map((lang) => (
          <DropdownItem key={lang.code} active={lang.code === i18n.language.slice(0, 2)} data-lang={lang.code} onClick={changeLanguage}>
            {lang.name}
          </DropdownItem>
        ))}
        <a className="px-2 d-none d-sm-block text-center ows-translateCTA" href="https://github.com/elamperti/OpenWebScrobbler/#translations">
